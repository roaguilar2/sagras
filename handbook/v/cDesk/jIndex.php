                            ...
                            <div class="col s12">
                                <div class="p-t-20 p-b-20 p-l-20 p-r-20">
                                    <table id='example' class='display nowrap' style='width:100%'>
                                        <thead>
                                            <tr>
                                                <td class="td-block">handbook</td>
                                                <td>Acci&oacute;n</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php while ($handbook = $_handbook -> fetch_object()) { ?>
                                            <tr>
                                                <td>
                                                    <?php echo $handbook -> handbookName; ?>
                                                </td>
                                                <td>
                                                    <a href="
                                                        <?php
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $link = $allow == 1 ? "../c/{$module}.php?m=update&id={$handbook -> handbookId}" : "javascript: void(0)";
                                                        }
                                                        else {
                                                            echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update&id={$handbook -> handbookId}" : "javascript: void(0)";
                                                        }
                                                    ...
                                                    <a href="
                                                        ...
                                                        if ($_SESSION["userAdmin"] == 4) {
                                                            $allow = 1;
                                                            echo $link = $allow == 1 ? "../c/{$module}.php?m=delete&id={$handbook -> handbookId}" : "javascript: void(0)";
                                                        }
                                                        else {
                                                            echo $link = $allow -> jDelete == 1 ? "../c/{$module}.php?m=delete&id={$handbook -> handbookId}" : "javascript: void(0)";
                                                        }
...
<div id="help" class="handbook center">
<div class="handbook-content">
    <p class="left">Aceptaci&oacute;n y Continuidad</p>
</div>
<div class="handbook-footer m-t--20 m-b-10">
    <button class="handbook-close waves-effect waves-light btn blue">Cerrar</button>
</div>
</div>
