    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/pcproject.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <a href="../c/pcproject.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l4">
                                                            <div class="input-field">
                                                                <input id="pcprojectName" name="pcprojectName" placeholder="" type="text" class="validate" required>
                                                                <label for="pcprojectName">Pregunta Conclusion Proyecto</label>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="pcprojectText" class="ckeditor m-t-20" required>
                                                                 </textarea>
                                                                 <label  for="textarea1">Pregunta Conclusion Proyecto</label>
                                                            </div>
                                                        </div>
...
<!-- img 1-->
                                        ...
                                        <div class="row">
                                            <div class="col s12 m-t-20">
                                                <a href="../c/pcproject.php?m=index" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
    ...
    <div id="help" class="modal">
        <div class="modal-content">
            <p class="">Pregunta Conclusion Proyecto</p>
