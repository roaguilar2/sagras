    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/ras.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l4">
                                                            <div class="input-field">
                                                                <input id="rasName" name="rasName" placeholder="" type="text" class="validate" required>
                                                                <label for="rasName">Nombre del diagn&oacute;stico</label>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="rasText" class="ckeditor m-t-20" required>
                                                                 </textarea>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="rasText2" class="ckeditor m-t-20" required>
                                                                 </textarea>
