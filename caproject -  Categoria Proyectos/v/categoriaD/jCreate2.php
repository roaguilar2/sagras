                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col s12 m5 l6 ">
                                                         <div class="input-field">
                                                            ...
                                                            <label class="active" for="designatedId">Caproject</label>
                                                         </div>
                                                    </div>
                                            ...
                                            <table class="white">
                                                <thead>
                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                        ...
                                                        <td id="border-white" class="left">Caproject</td>
                                          ...
                                          <ul class="collapsible ">         
                                             <li>
                                                <div class="collapsible-header">
                                                    ...
                                                    <span class="blue-grey-text text-darken-2">Caprojects</span>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col l12">
                                                             ...
                                                             <table class="white">
                                                                    <thead>
                                                                        <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                                            <td id="border-white" class="center">Caproject</td>
                                                                            <td id="border-white" width="10%"></td>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                ...
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
                                                            <div class="col l10">
                                                                <div class="input-field">
                                                                    <label for="shareholderName">Nombre de la Caproject</label>
                                            ...
                                            <li>
                                                <div class="collapsible-header">
                                                    <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                    <span class="blue-grey-text text-darken-2">Preguntas y Caprojects</span>
                                                </div>
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
