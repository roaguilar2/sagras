        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#help" class="tooltipped right modal-trigger" data-position="left" data-tooltip="Requerimiento ">
...
<form id="form_validation" action="../c/requerimiento.php?m=createDb2&requerimientoId=<?php echo $requerimientoId; ?>&requerimientoNumber=<?php echo $requerimientoNumber; ?>" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m8">
                                                <div class="input-field">
                                                    ...
                                                    <label class="" for="titulo">Servicio:</label>
                                            ...
                                            <div class="col s12 m4">
                                                <div class="input-field">
                                                    <input value="<?php echo  $requerimientoName  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required readonly >
                                                    <label class="" for="titulo">Requerimiento:</label>
                                                        ...
                                                        <div class="col s12 m6">
                                                             <div class="input-field">
                                                                 <textarea id="ckeditor" name="requerimiento<?php echo $contador ; ?>" class="ckeditor m-t-20" required>
                                                                 </textarea>
                                                                 <label  for="textarea1">Requerimiento <?php echo $contador ; ?></label>
                                                            </div>
                                                        </div>
                                                        <?php $contador++; } ?>
