                                ...
                                <div class="row">
                                            <div class="col s12 m3">
                                                <div class="input-field">
                                                    <input value="<?php echo  $requerimientoName  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required >
                                            ...
                                            <div class="col s12 m7">
                                                <div class="input-field">
                                                    <input value="<?php echo  $serviceName  ; ?>" id="titulo" name="titulo" placeholder="" type="text" class="validate" required >
                                        ...
                                        <div class="col s12 m12 l12 ">
                                                <div class="input-field">
                                                    ...
                                                    <?php echo $client -> requerimientoText; ?>
                                                     </textarea>
