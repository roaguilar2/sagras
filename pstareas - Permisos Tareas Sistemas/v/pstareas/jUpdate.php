        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m-b-5">
                    ...
                    <a href="#!" class="breadcrumb hide-on-med-and-down">Pstareass</a>
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="../c/pstareas.php?m=index" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                            ...
                            <div class="card m-t-10 m-l-5 m-r-5">
                                <div class="p-l-20 p-t-20 p-r-20 p-b-20">
                                    ...
                                    <form id="form_validation" action="../c/pstareas.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col s12 m-t-20 m-b-10">
                                            <table class="white">
                                                ...
                                                <tbody>
                                                <?php while ($pstareas = mysqli_fetch_array($p)) { ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo  $pstareas["userName"];  ?>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                            if ( $pstareas["designatedId"] == 1){
                                                                
                                                            echo 'Completar';  
                                                            
                                                            }
                                                            if ( $pstareas["designatedId"] == 2){
                                                                
                                                            echo 'Revisar';  
                                                            
                                                            }
                                                            if ( $pstareas["designatedId"] == 3){
                                                        ...
                                                        <td>
                                                         <?php 
                                                            if ( $pstareas["grupoId"] == 1){
                                                                
                                                            echo 'Auditoría';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 2){
                                                                
                                                            echo 'Auditoría Interna';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 3){
                                                                
                                                            echo 'Consultoría';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 4){
                                                                
                                                            echo 'Fiscal';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 5){
                                                                
                                                            echo 'Asistencia Técnica';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 6){
                                                                
                                                            echo 'Metodología';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 7){
                                                                
                                                            echo 'sistemas';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 8){
                                                                
                                                            echo 'Administración';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 9){
                                                                
                                                            echo 'Recursos Humanos';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 10){
                                                                
                                                            echo 'Desarrollo Profesional';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 11){
                                                                
                                                            echo 'Control de Calidad';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 12){
                                                                
                                                            echo 'Riesgo y Código de Ética y Conducta';  
                                                            
                                                            }
                                                            if ( $pstareas["grupoId"] == 13){
                                                        ...
                                                        <td>
                                            <a href="../c/pstareas.php?m=deleteDb&id=<?php echo $pstareas["pstareasId"]; ?>&u=<?php echo $_GET["id"]; ?>" class="tooltipped m-l-10" data-position="top" data-tooltip="Eliminar"><i class="material-icons red-text">delete</i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
