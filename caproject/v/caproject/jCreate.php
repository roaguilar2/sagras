    <main>
        ...
        <div class="container">
            ...
            <form id="form_validation" action="../c/caproject.php?m=createDb" method="post" enctype="multipart/form-data"  onsubmit="return checkForm(this);" >
                <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 m6 l4">
                                                            <div class="input-field">
                                                                ...
                                                                <label for="tdatosName">Categorias Proyecto </label>
                                                        ...
                                                        <div class="col s12 m6 l12 ">
                                                             <div class="input-field">
                                                                 ...
                                                                 <label  for="textarea1">Categorias Proyecto </label>
                                                            </div>
                                                        </div>
