...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 m-b-5">
            ...
            <a href="#!" class="breadcrumb hide-on-med-and-down">Pproject</a>
    ...
    <form id="form_validation" action="../c/pproject.php?m=updateDb&cid=<?php echo $d; ?>&pid=<?php echo $pid;?>" method="post">
        <div class="row">
            <div class="col s12 m12 l12 m-t-5">
                <div class="card blue-grey lighten-5 hoverable">
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12">
                                <span class="blue-text p-l-10">Pproject</span>
                                <a href="../c/pproject.php?m=list&pid=<?php echo $_GET["cid"];?>" class="tooltipped right m-l-5" data-position="left" data-tooltip="Cerrar">
                         ...
                         <div class="row">
                            ...
                            <div class="row">
                                        <div class="col s12 m12 l12  ">
                                                 <div class="input-field">
                                                    <input id="pprojectName" name="pprojectName" value="<?php echo $c -> pprojectName; ?>" type="text"  >
                                                    <label class="active" for="pprojectName">pproject  </label>
                                                 </div>
                                         </div>
                                                                    ...
                                                                    <table class="white">
                                                                        <tr class="left-align">
                                                                            <td >
                                                                                <div>
                                                                                    <label>
                                                                    <input value="<?php echo $cp -> categoriasId; ?>" type="hidden" name="pprojectsC[]" />
                                ...
                                <div class="row">
                                    <div class="col s12 m-t-20">
                                        <a href="../c/pproject.php?m=list&pid=<?php echo $_GET["cid"];?>" class="btn red waves-light tooltipped" data-position="top" data-tooltip="Cancelar">
