                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <a href="<?php if ($_SESSION["dsheetAdmin"] == 4) { echo "javascript: void(0)"; } else { echo $link = $allow -> jCreate == 1 ? "../c/{$module}.php?m=create" : "javascript: void(0)"; } ?>" class="tooltipped right" data-position="left" data-tooltip="Nuevo Registro">
                                        <i class="material-icons <?php if ($_SESSION["dsheetAdmin"] == 4) { echo "grey-text"; } else { echo $color = $allow -> jCreate == 1 ? "blue-text" : "grey-text"; } ?>">add_circle</i>
                                    </a>
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            switch ($_dsheet) {
                                                                ...
                                                                case $dsheet -> dsheetAdmin == 1:
                                                                    echo "Est&aacute;ndar";
                                                                    break;

                                                                case $dsheet -> dsheetAdmin == 2:
                                                                    echo "Administrador";
                                                                    break;

                                                                case $dsheet -> dsheetAdmin == 3:
                                                                    echo "Socio de Riesgo";
                                                                    break;

                                                                case $dsheet -> dsheetAdmin == 4:
                                                                    echo "Consultor";
                                                                    break;

                                                                case $dsheet -> dsheetAdmin == 5:
                                                        ...
                                                        <?php if ($_SESSION["dsheetAdmin"] == 4) { ?>
                                                        <td class="center">
                                                            <a target="_blank" href='../plugins/pdf/doc/dsheet.php?id=<?php echo $dsheet -> dsheetId; ?>' class='tooltipped' data-position='left' data-tooltip='Ver'><i class='material-icons blue-text'>search</i></a>
                                                        </td>
                                                        <?php } else { ?>
                                                        <td>
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["dsheetAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=read&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jRead == 1 ? "../c/{$module}.php?m=read&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["dsheetAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=update&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jUpdate == 1 ? "../c/{$module}.php?m=update&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
                                                            ...
                                                            <a href="
                                                                ...
                                                                if ($_SESSION["dsheetAdmin"] == 4) {
                                                                    $allow = 1;
                                                                    echo $link = $allow == 1 ? "../c/{$module}.php?m=delete&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
                                                                else {
                                                                    echo $link = $allow -> jDelete == 1 ? "../c/{$module}.php?m=delete&id={$dsheet -> dsheetId}" : "javascript: void(0)";
                                                                }
