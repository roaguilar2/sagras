                                ...
                                <div class="m-b-20 m-l-20 m-r-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php
                                            $name = $dsheet -> dsheetName ;
                                            $surname = $dsheet -> dsheetSurname ; 
                                            echo $name . ' ' . $surname;
                                            ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> civilStatusName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetBirthday ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> genderName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetEmail ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetPhone1 ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetPhone2 ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetAddress ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetCity ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetState ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> countryName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m-t-10 m-b-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> dsheetAdmission ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> officeName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> divisionName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> departmentName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12 m4">
                                        ...
                                        <div class="col s12 m8">
                                            <span><?php echo $dsheet -> levelName ; ?></span>
                                        </div>
                                    </div>
                                    <div class="row">
