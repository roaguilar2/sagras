...
<div class="container">
    ...
    <form id="form_validation" action="../c/dsheet.php?m=updateDb&id=<?php echo $_GET["id"]; ?>" method="post">
        <div class="row">
                                            ...
                                            <div id="P4" class="col s12">
                                                ...
                                                <div class="row">
                                                    <div class="col s12">
                                                        <p>
                                                            <label>
                                                                <input name="dsheetAdmin" type="radio" value="1" <?php echo $checked = $dsheet -> dsheetAdmin == 1 ? "checked" : ""; ?>/>
                                                                <span>Est&aacute;ndar</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label>
                                                                <input name="dsheetAdmin" type="radio" value="2" <?php echo $checked = $dsheet -> dsheetAdmin == 2 ? "checked" : ""; ?>/>
                                                                <span>Administrador</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label>
                                                                <input name="dsheetAdmin" type="radio" value="3" <?php echo $checked = $dsheet -> dsheetAdmin == 3 ? "checked" : ""; ?>/>
                                                                <span>Socio de Riesgo</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label>
                                                                <input name="dsheetAdmin" type="radio" value="4" <?php echo $checked = $dsheet -> dsheetAdmin == 4 ? "checked" : ""; ?>/>
                                                                <span>Consultor</span>
                                                            </label>
                                                        </p>
                                                        <p>
                                                            <label>
                                                                <input name="dsheetAdmin" type="radio" value="5" <?php echo $checked = $dsheet -> dsheetAdmin == 5 ? "checked" : ""; ?>/>
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-20">
                                                        ...
                                                        <?php echo $action = $_SESSION["dsheetAdmin"] != 4 ? "<button id='vDsheet' type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Guardar Cambios'><i class='material-icons'>save</i></button>" : "<button class='btn disabled'><i class='material-icons'>save</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
