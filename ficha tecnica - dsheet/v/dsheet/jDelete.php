                                ...
                                <div class="row">
                                    <div class="col s12">
                                        <div class="m-t-20 m-b-20 m-l-20 m-r-20">
                                            <form id="form_validation" action="../c/dsheet.php?m=deleteDb&id=<?php echo $_GET["id"]; ?>" method="post">
                                                <div class="row">
                                                    <div class="col s12 m6 l4">
                                                        <div class="input-field">
                                                            <input value="<?php echo $dsheet -> dsheetName . " " . $dsheet -> dsheetSurname; ?>" type="text" disabled="">
                                                ...
                                                <div class="row">
                                                    <div class="col s12 m-t-30">
                                                        ...
                                                        <?php echo $action = $_SESSION["dsheetAdmin"] != 4 ? "<button type='submit' class='btn blue waves-effect tooltipped' data-position='right' data-tooltip='Eliminar'><i class='material-icons'>delete</i></button>" : "<button class='btn disabled'><i class='material-icons'>delete</i></button>"; ?>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
