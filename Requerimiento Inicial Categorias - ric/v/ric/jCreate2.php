                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col s12 m5 l6 ">
                                                         <div class="input-field">
                                                            ...
                                                            <label class="active" for="designatedId">Ric</label>
                                                         </div>
                                                    </div>
                                            ...
                                            <table class="white">
                                                <thead>
                                                    <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                        ...
                                                        <td id="border-white" class="left">Ric</td>
                                          ...
                                          <ul class="collapsible ">         
                                             <li>
                                                <div class="collapsible-header">
                                                    ...
                                                    <span class="blue-grey-text text-darken-2">Rics</span>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col l12">
                                                             ...
                                                             <table class="white">
                                                                    <thead>
                                                                        <tr class="grey lighten-3 blue-grey-text text-darken-1">
                                                                            <td id="border-white" class="center">Ric</td>
                                                                            <td id="border-white" width="10%"></td>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                ...
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
                                                            <div class="col l10">
                                                                <div class="input-field">
                                                                    <label for="shareholderName">Nombre de la Ric</label>
                                            ...
                                            <li>
                                                <div class="collapsible-header">
                                                    <i class="material-icons blue-grey-text text-lighten-2">keyboard_arrow_right</i>
                                                    <span class="blue-grey-text text-darken-2">Preguntas y Rics</span>
                                                </div>
                                                <div class="collapsible-body">
                                                    <div class="field_wrapper ">
                                                        <div class="row">
