...
// var
$ccprojectName = filter_var($_POST['d'], FILTER_SANITIZE_STRING);
...
$update -> bind_param (
    "sssi",
    $ccprojectName, $ccprojecttext, $ccprojecttext2, $_GET["cid"]
);
...
$id = $_GET["cid"];
    ...
    foreach ($_FILES["archivo2"]['tmp_name'] as $key => $tmp_name) {
        ...
        if ($_FILES["archivo2"]["name"][$key]) {
            ...
            $directorio2 = '../ccproject/' . $id . '/'; //Declaramos un  variable con la ruta donde guardaremos los archivos
